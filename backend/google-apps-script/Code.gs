...
1. ตรวจสอบชนิดมิเตอร์:
   - หากเป็นมิเตอร์น้ำ: สแกนหา Serial Number เช่น "193019061" (มิเตอร์น้ำหลัก), "F19S000630" (มิเตอร์น้ำ Soft), "F19S000648" (มิเตอร์น้ำ EVAP) และอ่านค่าตัวเลขลูกบาศก์เมตร (m³)
